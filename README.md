...
| To Be Snipped | To Be Post-Snipped | Confirm manual crop: open this SU's pre-snip bins in CloudCompare (Open in CC ↗), crop top & bottom, and save over the same files (no rename) in `Data/SU<su>/` before running Post-Snip. |
